...
The information about the gross domestic product comes from the worldbank and was scraped with the WDI package for R. The scraped data comes in a country-year format, thus it was already in a format we need to conduct our analysis.
...
# Visualizing and examing the data
