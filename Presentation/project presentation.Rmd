...
3D Globes using the 'threejs' Package: The [3D Globe package](file:///Users/laurencehendry/GoogleDrive/Master%20Thesis%20-%20Shared/MPP-E1180%20-%20Introduction%20to%20Collaborative%20Social%20Science%20Data%20Analysis/Laurence-Github/Working%203D%20Globe/Model%20v1.html). The 3D globes are full navigable, with pinch-zooming enabled for trackpads to help with examining statistical results in particular regions. 
...
plot(ship.ucdp.mil$IntensityLevel, ship.ucdp.mil$`Military Expenditure`, main="Showing the Correlation between Intensity Level and Military Expenditure", data=ship.ucdp.mil, xlab="Military Expenditure", ylab="Intensity Level")

plot(ship.ucdp.mil$`Military Expenditure`, ship.ucdp.mil$`attacks/Year`, main="Visualizing Military Expenditure's affect on Attacks per year ", data=ship.ucdp.mil, xlab="Military Expenditure", ylab="Attacks Per Year"))
```
